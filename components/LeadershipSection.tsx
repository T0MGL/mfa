...
export default function LeadershipSection({ label, title }: LeadershipSectionProps) {
  return (
    <section className="py-20 md:py-32 border-t border-[#ededed]/5 bg-gradient-to-b from-[#0B0B0C] to-[#15151a]">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          {leaders.map((leader, index) => (
            ...
            >
              {/* Image Container */}
              <div className="relative aspect-[3/4] overflow-hidden bg-[#1a1a1f] mb-6">
                <Image
                  src={leader.image}
                  alt={leader.name}
                  fill
