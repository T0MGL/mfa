    ...
    return (
        ...
        >
            <div className="flex justify-between items-end mb-2">
                <span className={`text-[15px] tracking-[0.1em] uppercase ${isHighlight ? "text-[#c9a96e] font-semibold" : "text-white/60"}`}>
                    {country}
                </span>
                <span className={`text-[16px] ${isHighlight ? "text-[#c9a96e]" : "text-white/40"}`}>
                    {value}
                </span>
            </div>
            ...
            <div className="h-10 bg-white/5 relative flex items-center overflow-hidden rounded-sm">
                ...
                />
                <span className={`relative z-10 pl-3 text-[14px] ${isHighlight ? "text-[#0a0a0f] font-semibold" : "text-white/40"}`}>
                    {note}
                </span>
            </div>
        </motion.div>
                    ...
                    <div className="grid md:grid-cols-[280px_1fr] gap-12 md:gap-20">
                        ...
                        <div>
                            <motion.h2
                                ...
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                className="text-[clamp(2.25rem,4vw,3.75rem)] font-serif leading-[1.12] text-[#eae7e0] mb-6"
                            >
                                {t("macro.title")}
                            </motion.h2>
                            <motion.p
                                ...
                                className="text-[17px] text-white/60 leading-[1.8] max-w-[700px] mb-16"
                            >
                                {t("macro.subtitle")}
                            </motion.p>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-20">
                                {(["gdp", "grade", "age", "happy", "debt"] as const).map((stat, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-[13px] tracking-[0.1em] uppercase text-white/60 font-semibold mb-2">
                                            {t(`macro.stats.${stat}.label`)}
                                        </div>
                                        <div className="text-[15px] text-white/30 leading-snug">
                            ...
                            >
                                <div className="mb-10">
                                    ...
                                    <p className="text-[14px] uppercase tracking-[0.1em] text-white/40">{t("macro.climate.label")}</p>
                                </div>
                    ...
                    <div className="grid md:grid-cols-[280px_1fr] gap-12 md:gap-20">
                        ...
                        <div>
                            ...
                            <motion.p
                                ...
                                viewport={{ once: true }}
                                transition={{ delay: 0.1 }}
                                className="text-[16px] text-white/60 leading-[1.65] max-w-[600px] mb-12"
                            >
                                {t("tax.detail")}
                            </motion.p>
                            ...
                            <motion.div
                                ...
                                className="mt-12 p-8 border border-[#a68a5c]/20 bg-[#a68a5c]/5 relative overflow-hidden"
                            >
                                ...
                                <p className="mt-4 text-[16px] text-white/60 leading-[1.65] max-w-[500px] relative z-10">
                ...
                <div className="max-w-[1400px] mx-auto px-6 md:px-12">
                    <div className="grid md:grid-cols-[280px_1fr] gap-12 md:gap-20">
                        ...
                        >
                            ...
                            <p className="text-[17px] text-white/60 leading-[1.8] max-w-[700px]">
